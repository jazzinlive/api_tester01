...
class QRAllPayment extends StatefulWidget {
  const QRAllPayment({Key? key}) : super(key: key);

  @override
  State<QRAllPayment> createState() => _QRAllPaymentState();
}

class _QRAllPaymentState extends State<QRAllPayment> {
  ...
  late String ref1 = "QRALL" + DateFormat("yyyyMMddhhmmss").format(now);
