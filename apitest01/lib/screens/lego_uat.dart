...
class LegoUAT extends StatefulWidget {
  const LegoUAT({Key? key}) : super(key: key);

  @override
  State<LegoUAT> createState() => _LegoUATState();
}

class _LegoUATState extends State<LegoUAT> {
      ...
      body: Container(
          decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/gbg03.jpg'),
                  fit: BoxFit.cover,
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            width: double.infinity,
                            height: 35,
                            child: context.read<JWTModels>().respDesc ==
                                    "Success"
                                ? ElevatedButton(
                                    onPressed: () async {
                                      Navigator.push(
