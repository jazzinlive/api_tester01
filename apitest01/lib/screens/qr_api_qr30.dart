...
class QR30Payment extends StatefulWidget {
  const QR30Payment({Key? key}) : super(key: key);

  @override
  State<QR30Payment> createState() => _QR30PaymentState();
}

class _QR30PaymentState extends State<QR30Payment> {
